    ...
    try {
        ...
        await send('Runtime.evaluate', {
            expression: `
                ...
                if (typeof switchSubTab === 'function') switchSubTab('perf', 'plan'); window.planningStatusFilter = 'all'; const sel = document.getElementById('filter-planning-status'); if (sel) sel.value = 'all'; renderPlanningRosterTable();
            `
        });
