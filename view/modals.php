        ...
        <div id="modal-recognition" class="fixed inset-0 modal-overlay z-50 hidden items-center justify-center p-4">
            <div
                ...
                <div class="p-6 space-y-4 overflow-y-auto custom-scrollbar flex-1 text-xs bg-white">
                    ...
                    <!-- Recognition Type / Sender Role Selector (Deterministic Rules) -->
                    <div class="p-3 bg-[#FAF8F7] rounded-2xl border border-[#E8DEDC] space-y-2">
                        <label class="block font-bold text-slate-800 text-[11px]">Recognition Type &amp; Deterministic XP Rule</label>
                        <div class="grid grid-cols-2 gap-2">
                            <label class="flex items-center space-x-2 p-2 rounded-xl border border-slate-200 bg-white hover:border-amber-400 cursor-pointer transition">
                                <input type="radio" id="kudos-role-peer" name="kudos_sender_role" value="peer" checked class="accent-amber-600">
                                <div>
                                    <span class="text-[11px] font-bold text-slate-800 block">Peer-to-Peer</span>
                                    <span class="text-[10px] text-amber-700 font-semibold">+50 XP to Recipient</span>
                                </div>
                            </label>
                            <label class="flex items-center space-x-2 p-2 rounded-xl border border-slate-200 bg-white hover:border-amber-400 cursor-pointer transition">
                                <input type="radio" id="kudos-role-supervisor" name="kudos_sender_role" value="supervisor" class="accent-amber-600">
                                <div>
                                    <span class="text-[11px] font-bold text-slate-800 block">Supervisor Commendation</span>
                                    <span class="text-[10px] text-primary font-semibold">+100 XP to Recipient</span>
                                </div>
                            </label>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <select id="kudos-category-select" class="w-full px-3 py-2 rounded-xl border border-slate-200 bg-slate-50 text-xs font-semibold text-slate-800 focus:ring-2 focus:ring-amber-500 focus:outline-none">
                            <option value="guest_service">🌟 Great Guest Service</option>
                            <option value="collaboration">🤝 Team Collaboration &amp; Support</option>
                            <option value="safety_haccp">🛡️ Safety &amp; HACCP Compliance</option>
                            <option value="crisis_recovery">⚡ Crisis &amp; Conflict Recovery</option>
                    ...
                    <!-- Kudos Message -->
                    <div>
                        <label class="block font-bold text-slate-800 text-[11px] mb-1">Recognition Message / Specific Accomplishment</label>
                        <textarea id="shoutout-message" rows="2"
                            ...
                            placeholder="e.g., Outstanding calm composure during the peak dinner rush and seamless VIP table recovery!"></textarea>
                    </div>
                </div>
                ...
                <div
                    ...
                    <span id="kudos-awarded-preview"
                        class="badge-gold">+50 XP / Person</span>
                    <div class="flex items-center space-x-2.5">
                        <button onclick="closeModal('modal-recognition')"
                            class="btn-secondary px-4 py-2 text-xs font-semibold">Cancel</button>
                        <button onclick="dispatchRecognition()"
                            class="btn-primary px-5 py-2 text-xs font-bold">
                            <span id="kudos-submit-label">Post Recognition &amp; Award XP</span>
                        </button>
                    </div>
                </div>
            </div>
